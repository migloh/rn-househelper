...
export default function Signup({route, navigation}: SignupProps) {
  ...
  const onClickSignUp = () => {
    ...
    if (role === 'Employee' && availabilite === '')
      Alert.alert('Warning!', 'Please check your availability!');
    else if (queryStt === false)
        ...
        <ScrollView style={styles.scrollableContent}>
          ...
          <View
            style={[
              ...
              {
                borderColor:
                  inputBorderMail == true ? Blues.blue_2 : Grays.gray_2,
              },
            ]}>
            <TextInput
              style={styles.textInput}
          ...
          <View
            style={[
              ...
              {
                borderColor:
                  inputBorderPass == true ? Blues.blue_2 : Grays.gray_2,
              },
            ]}>
            <TextInput
              style={styles.textInput}
          ...
          <View style={[styles.inputArea, {paddingHorizontal: 0}]}>
            <Picker
              style={
                province === 'none' ? styles.pickerNone : styles.pickerPicked
              }
          ...
          <View style={[styles.inputArea, {paddingHorizontal: 0}]}>
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) => {
                ...
                setWardList([]);
                setWard('');
                let res = districtList.find(
                  element => element.name == itemValue,
                );
