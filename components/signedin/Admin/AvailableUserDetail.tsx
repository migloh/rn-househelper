...
export default function AvailableuserDetail({route, navigation}: AvailableUserDetailProps) {
  ...
  var guessAge: number = new Date().getFullYear() -  guessDate.getFullYear();
	var guessDob: string = guessDate.getDate() + '/' + (guessDate.getMonth() + 1) + '/' + guessDate.getFullYear();
        ...
        <ScrollView style={styles.scrollableContent}>
          ...
          <View style={[styles.selfIntro, {marginBottom: 30}]}>
            <View style={{flexDirection: 'row'}}>
              ...
              <InfoCard style={styles.infoCard} title="Date of Birth" detail={guessDob} />
            </View>
