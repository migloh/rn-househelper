...
const Transmit = ({item}: any) => (
  <View style={styles.transmitter}>
    <TouchableOpacity
      ...
      style={
        item.data.senderID === currentUid ? styles.isSender : styles.isReceiver
      }>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.messageBar}>
        ...
        />
        <TouchableOpacity onPress={useCallback(() => sendGo(text), [text])}>
